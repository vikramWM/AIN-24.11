				...
				<td>
														...
														<tr>
															<td class="pad">
																<div style="color:#ffffff;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:24px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:28.799999999999997px;">
																	<p style="margin: 0;"> <img style="width:50px; height:auto;" src="https://londonstreetstore.com/assets/media/avatars/logo-white.png" alt="Loading IMG"> </p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 639.2px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/8171/Email-Illustration.png" style="display: block; height: auto; border: 0; width: 100%;" width="639.2" alt="An open email illustration" title="An open email illustration"></div>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 48px; padding-left: 48px; padding-right: 48px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-top:12px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #292929; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 32px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 38.4px;"><span class="tinyMce-placeholder">Confirm your Order !</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Dear <b> {{$mailData['name']}} </b> <br> We extend our sincere appreciation for choosing Assignment In Need for your assignment requirements. Your trust in our services is valued, and we are committed to delivering exceptional assistance.&nbsp;<br><br>Our team of seasoned experts is well-equipped to address the specifications outlined in your assignment brief and any additional requirements you may have communicated. Rest assured, our dedication is focused on ensuring the delivery of high-quality work for your placed order. <br>
																		&nbsp;</p>
																</div>
															</td>
													...
													<table style="width: 100%; border-collapse: collapse;">
														<thead>
															<tr>
																...
																<th style="border: 1px solid #ddd; padding: 8px; background-color: #f2f2f2;">Delivery Date</th>
															</tr>
														</thead>
														<tbody>
															<!-- Add table data here -->
															<tr>
																<td style="border: 1px solid #ddd; padding: 8px;">{{$mailData['order_code']}}</td>
																<td style="border: 1px solid #ddd; padding: 8px;">{{$mailData['title']}}</td>
																<td style="border: 1px solid #ddd; padding: 8px;">{{$mailData['date']}}</td>
															</tr>
													...
													<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Furthermore, we have set up a personalized portal for you, providing access to valuable features such as checking job status, sharing feedback, and placing future orders.</p>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<b style="margin: 0; text-align: center; margin: auto;">Your portal login information is as follows: 
																		<br> 
																		</b>
													...
													<br>
													<table style="width: 100%; border: 1px solid #ccc; border-collapse: collapse; margin: auto;">
														<thead>
														  <tr>
															<th style="padding: 10px; text-align: center; background-color: #f2f2f2; border-bottom: 1px solid #ccc;" colspan="2">Your Log in details are as follows (link)</th>
														  </tr>
														</thead>
														<tbody>
														  <tr>
															<td style="padding: 10px; text-align: center; width: 50%;">Email:</td>
															<td style="padding: 10px; width: 50%;">{{$mailData['email']}}</td>
														  </tr>
														  <tr>
															<td style="padding: 10px; text-align: center;">Password:</td>
															<td style="padding: 10px;">user@123 (Unless You Change)</td>
														  </tr>
														</tbody>
													  </table>
													  <br>
													<table class="button_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																	<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																		<b style="margin: 0; text-align: center; margin: auto;">This portal serves as a comprehensive solution for managing all your assignment-related tasks efficiently.
																			<br> 
																			</b>
															...
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																	<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																		<p style="margin: 0; text-align: center; margin: auto;">If you have any concerns or queries, please feel free to communicate them. We are here to address any questions you may have and to ensure your satisfaction throughout the process.
																			<br> 
																		</p>
															...
															<tr>
																<td class="pad" style="padding-bottom:10px;padding-top:10px;">
																	<div style="color:#101112;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																		<b style="margin: 0; text-align: center; margin: auto;">Thank you once again for choosing Assignment In Need. We look forward to assisting you with the utmost dedication.
													...
													<table style="width: 100%; border: 1px solid #ccc; border-collapse: collapse; margin: auto;">
														...
														<tbody>
														  <tr>
															<td style="padding: 10px; text-align: left; width: 10%;"><b>Best regards,</b></td>
															
														  </tr>
														  <tr>
															<td style="padding: 10px; width: 50%; text-align: left;"><b> Daniel</b></td>
														  </tr>
														  <tr>
															<td style="padding: 10px; width: 50%; text-align: left;"><b>Assignment In Need
																</td>
														  </tr>
														  <tr>
															<td style="padding: 10px; width: 50%; text-align: left;"><b>Order@assignnmentinneed.com
																</td>
														  </tr>
														  <tr>
															<td style="padding: 10px; width: 50%; text-align: left;"><b>Whatsapp Number: +44 7826233106
																</td>
														  </tr>
														</tbody>
													  </table>
					...
					<table class="row row-4" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e8e4ff; border-bottom: 0 solid #FFFFFF; border-left: 20px solid #FFFFFF; border-radius: 0; border-right: 20px solid #FFFFFF; border-top: 0 solid #FFFFFF; color: #000000; width: 680px; margin: 0 auto;" width="680">
										<tbody>
											<tr>
														...
														<tr>
															<td class="pad">
																<div style="color:#7860ff;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
																	<p style="margin: 0;">Invite your friends to our community and earn credits to win gifts <br><strong><a href="https://www.assignnmentinneed.com/" target="_blank" style="text-decoration: underline; color: #3e2d9c;" rel="noopener">Share with Friends</a></strong></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:32px;">
																<div style="color:#ffffff;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:24px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:28.799999999999997px;">
																	<p style="margin: 0;"> <a href="assets/media/avatars/logo-white.png"></a></p>
																</div>
															</td>
														</tr>
													</table>
																...
																<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
																	<tr>
																		<td class="alignment" style="text-align:center;font-size:0px;">
																			<div class="menu-links"><!--[if mso]><table role="presentation" border="0" cellpadding="0" cellspacing="0" align="center" style=""><tr style="text-align:center;"><![endif]--><!--[if mso]><td style="padding-top:0px;padding-right:16px;padding-bottom:0px;padding-left:16px"><![endif]--><a href="https://www.assignnmentinneed.com/" target="_self" style="mso-hide:false;padding-top:0px;padding-bottom:0px;padding-left:16px;padding-right:16px;display:inline-block;color:#3e2d9c;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;text-decoration:none;letter-spacing:1px;">Home</a><!--[if mso]></td><td><![endif]--><span class="sep" style="font-size:16px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#3e2d9c;">|</span><!--[if mso]></td><![endif]--><!--[if mso]><td style="padding-top:0px;padding-right:16px;padding-bottom:0px;padding-left:16px"><![endif]--><a href="https://www.assignnmentinneed.com/contact-us/" target="_self" style="mso-hide:false;padding-top:0px;padding-bottom:0px;padding-left:16px;padding-right:16px;display:inline-block;color:#3e2d9c;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;text-decoration:none;letter-spacing:1px;">contact us</a><!--[if mso]></td><td><![endif]--><span class="sep" style="font-size:16px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#3e2d9c;">|</span><!--[if mso]></td><![endif]--><!--[if mso]><td style="padding-top:0px;padding-right:16px;padding-bottom:0px;padding-left:16px"><![endif]--><a href="https://www.assignnmentinneed.com/" target="_self" style="mso-hide:false;padding-top:0px;padding-bottom:0px;padding-left:16px;padding-right:16px;display:inline-block;color:#3e2d9c;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;text-decoration:none;letter-spacing:1px;">Order Now</a><!--[if mso]></td><td><![endif]--><span class="sep" style="font-size:16px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;color:#3e2d9c;"></div>
																		</td>
																	</tr>
																</table>
															</td>
														...
														<tr>
															<td class="pad" style="padding-top:16px;">
																<div style="color:#443888;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
																	<p style="margin: 0;">All Right Riserved By <a href="https://www.assignnmentinneed.com/" target="_blank" style="text-decoration: underline; color: #3e2d9c;" rel="noopener">assignnmentinneed</a></p>
																</div>
															</td>
														</tr>
													</table>
