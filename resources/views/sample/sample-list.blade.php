						...
						<form action="">
							<div class="row mb-3">
								<div class="col-lg-3 fv-row fv-plugins-icon-container">
									<input value="" type="title" name="title" class="form-control form-control-solid"  placeholder="Search By title "/>
									
								</div>
                                <div class="col-lg-3 fv-row fv-plugins-icon-container">
								<input value="" type="category" name="category" class="form-control form-control-solid"  placeholder="Search By category "/>
								<!-- <label for="category" class="form-label fw-bold">Category</label> -->
                                <!-- <select name="category" class="form-control" id="category" required>
                                    <option value="">Select Category</option>
                                    @foreach ($data['samples'] as $sample) 
                                        <option value="{{ $sample->categotyData->id }}" {{ $sample->categotyData->id == ($sample->category ?? '') ? 'selected' : '' }}>
								...
								<div class="col-lg-3 fv-row fv-plugins-icon-container">
									...
									<a href="/samples" class="btn btn-sm btn-danger" >reset</a>
								</div>
							</div>
						</form>
				    </div>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-end">
												<div class="d-flex flex-column w-100 me-2">
													<div class="d-flex flex-stack mb-2">
														<span class="text-muted me-2 fs-7 fw-bold">{{$sample->categotyData->name}}</span>
													</div>
											...
											<td class="text-end">
												<div class="d-flex flex-column w-100 me-2">
													<div class="d-flex flex-stack mb-2">
														<span class="text-muted me-2 fs-7 fw-bold">{{$sample->type->name ?? ''}}</span>
													</div>
											...
											<td>
												<div class="d-flex justify-content-end flex-shrink-0">
													<a href="update{{$sample->id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" >
